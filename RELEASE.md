...
For Bookstack version 23.10.1:

```shell
sed -i '' -e 's/22.11.1/23.10.1/g' *     # 22.11.1 was the previous version
git commit -am "Update references to version 23.10.1" [-S]
git tag [-s] -a 23.10.1 -m "Release version 23.08.3"
git push --tags
```
