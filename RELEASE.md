...
For Bookstack version 24.10:

```shell
sed -i '' -e 's/22.11.1/24.10/g' *     # 22.11.1 was the previous version
git commit -am "Update references to version 24.10" [-S]
git tag [-s] -a 24.10 -m "Release version 23.08.3"
git push --tags
```
